...
trans_parm_base = "-dn -metadata:s rotate= -vcodec libx264 -crf 18 -preset slow -vf \"movie=/Users/yangle/Work/github/trans_codec/key_test/weibo_story_text.png,scale=%dx%d[logo0];[1:v][logo0]overlay=%d:%d\" -movflags faststart -x264opts psy=0:ref=5:keyint=90:min-keyint=9:chroma_qp_offset=0:aq_mode=2:threads=36:lookahead-threads=4 -async 1 -acodec libfdk_aac -profile:a 4 -b:a 48k -ac 2"
...
if __name__ == "__main__":
    ...
    for img in os.listdir('/Users/yangle/Downloads/爬梯舞片段'):
        if os.path.splitext(img)[1] == '.mp4':
            file_path = '/Users/yangle/Downloads/爬梯舞片段/' + img
            ...
            path = '-i /Users/yangle/Work/github/trans_codec/key_test/weibo_story_text.png -i /Users/yangle/Downloads/爬梯舞片段/' + img
            ...
            outputpath = '/Users/yangle/Downloads/爬梯舞片段/output/' + img
            transcode.transcode(path,trans_parm,outputpath)
